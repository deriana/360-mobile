      ...
      <Card style={{ gap: spacing.xs }}>
        ...
        {sortedParties.map((p, idx) => (
          <Pressable
            ...
            style={({ pressed }) => [styles.partyRow, { borderBottomColor: colors.border }, pressed && { opacity: 0.7 }]}
          >
...
const styles = StyleSheet.create({
  ...
  partyRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingVertical: spacing.xs, borderBottomWidth: 0.5 },
