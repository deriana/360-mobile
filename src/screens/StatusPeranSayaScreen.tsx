      ...
      >
        <View style={styles.heroTopRow}>
          ...
          <View style={{ flex: 1, gap: 4 }}>
            ...
            <Text style={styles.heroSubtitle}>
              Kader Aktif simPAN | Pengurus DPD | Caleg 2029
            </Text>
            <Text style={styles.heroNik}>
              NIK: {maskNik(user?.nikFull || '3273011204920001')} | HP: {maskPhone(user?.phone || '081234567890')}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.heroPillsRow}>
          ...
          <View style={styles.quickTag}>
            ...
            <Text style={styles.quickTagText}>Caleg DPRD Prov</Text>
          </View>
          <View style={styles.quickTag}>
            <Feather name="check-square" size={11} color="#86EFAC" />
            <Text style={styles.quickTagText}>Saksi BSN</Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.dimensionHeader}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Pill label="ANGGOTA AKTIF RESMI" tone="success" />
            </View>
        ...
        <View style={styles.dimensionHeader}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Pill label="KADER FORMAL MADYA" tone="success" />
            </View>
      ...
      <Card style={[styles.dimensionCard, { borderColor: colors.border }]}>
        <View style={styles.dimensionHeader}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Pill label="PENGURUS DPD KOTA" tone="info" />
            </View>
        ...
        <View style={[styles.dimBody, { borderTopColor: colors.border }]}>
          <View style={styles.propRow}>
            ...
            <Text style={[styles.propValue, { color: colors.text, fontFamily: fonts.bold }]}>
              Wakil Sekretaris DPD PAN Kota Bandung
            </Text>
          </View>
          <View style={styles.propRow}>
          ...
          <View style={styles.propRow}>
            ...
            <Text style={[styles.propValue, { color: colors.text }]}>PAN/A/Kpts/KU-SJ/082/2020</Text>
          </View>
          <View style={styles.propRow}>
            <Text style={[styles.propLabel, { color: colors.textMuted }]}>Kluster Penugasan</Text>
            <Text style={[styles.propValue, { color: colors.text }]}>Dapil Jabar I (Bandung & Cimahi)</Text>
          </View>
        </View>
      </Card>
      ...
      <Card style={[styles.dimensionCard, { borderColor: colors.border }]}>
        <View style={styles.dimensionHeader}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Pill label="BACALEG 2029 LOLOS" tone="primary" />
            </View>
        ...
        <View style={[styles.dimBody, { borderTopColor: colors.border }]}>
          ...
          <View style={styles.propRow}>
            ...
            <Text style={[styles.propValue, { color: colors.text }]}>Dapil Jabar I (Kota Bandung - Kota Cimahi)</Text>
          </View>
          <View style={styles.propRow}>
            <Text style={[styles.propLabel, { color: colors.textMuted }]}>Nomor Rekomendasi Urut</Text>
            <Text style={[styles.propValue, { color: '#E60012', fontFamily: fonts.bold }]}>#3 (Prioritas Pemenangan)</Text>
          </View>
          <View style={styles.propRow}>
      ...
      <Card style={[styles.dimensionCard, { borderColor: colors.border }]}>
        <View style={styles.dimensionHeader}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Pill
                label={(volunteerMembership?.status as string) === 'paused' || volunteerMembership?.status === 'inactive' ? 'BERHENTI SEMENTARA' : 'RELAWAN AKTIF'}
                tone={(volunteerMembership?.status as string) === 'paused' || volunteerMembership?.status === 'inactive' ? 'warning' : 'success'}
              />
            </View>
        ...
        <View style={[styles.dimBody, { borderTopColor: colors.border }]}>
          ...
          <View style={styles.propRow}>
            ...
            <Text style={[styles.propValue, { color: colors.text }]}>
              {currentUser?.coordinatorContact?.name || 'Asep Ridwan'} (Coblong)
            </Text>
          </View>
          <View style={styles.propRow}>
